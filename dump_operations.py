...
args_file = "/home/borisef/projects/cm/Output/outColorNetOutputs_08_03_20/k2tf/output_graph.pb"
if not os.path.exists(args_file):
    parser.exit(1, 'The specified file does not exist: {}'.format(args_file))
...
try:
    with tf.gfile.GFile(args_file, "rb") as f:
